...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"./pkg/apis/pipeline/v1beta1.ExecutionMode":                     schema_pkg_apis_pipeline_v1beta1_ExecutionMode(ref),
				...
				Properties: map[string]spec.Schema{
					...
					"executionMode": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("./pkg/apis/pipeline/v1beta1.ExecutionMode"),
						},
					},
				},
			},
...
func schema_pkg_apis_pipeline_v1beta1_TaskRunSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"./pkg/apis/pipeline/v1beta1.ExecutionMode", "./pkg/apis/pipeline/v1beta1.Param", "./pkg/apis/pipeline/v1beta1.TaskRef", "./pkg/apis/pipeline/v1beta1.TaskRunResources", "./pkg/apis/pipeline/v1beta1.TaskSpec", "./pkg/apis/pipeline/v1beta1.WorkspaceBinding", "github.com/tektoncd/pipeline/pkg/apis/pipeline/pod.Template", "k8s.io/apimachinery/pkg/apis/meta/v1.Duration"},
	}
}
...
func schema_pkg_apis_pipeline_v1beta1_TaskSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"./pkg/apis/pipeline/v1beta1.ExecutionMode", "./pkg/apis/pipeline/v1beta1.ParamSpec", "./pkg/apis/pipeline/v1beta1.Sidecar", "./pkg/apis/pipeline/v1beta1.Step", "./pkg/apis/pipeline/v1beta1.TaskResources", "./pkg/apis/pipeline/v1beta1.TaskResult", "./pkg/apis/pipeline/v1beta1.WorkspaceDeclaration", "k8s.io/api/core/v1.Container", "k8s.io/api/core/v1.Volume"},
	}
}
